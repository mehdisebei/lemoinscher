...
class FosUserUser
{
     ...
     * Add group
     *
     * @param \Front\FrontBundle\Entity\FosUserGroup $group
     * @return FosUserUser
     */
    public function addGroup(\Front\FrontBundle\Entity\FosUserGroup $group)
    {
        $this->group[] = $group;
     ...
     * @param \Front\FrontBundle\Entity\FosUserGroup $group
     */
    public function removeGroup(\Front\FrontBundle\Entity\FosUserGroup $group)
    {
