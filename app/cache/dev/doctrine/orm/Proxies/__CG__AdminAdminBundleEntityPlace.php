 ...
 */
class Place extends \Admin\AdminBundle\Entity\Place implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Admin\\AdminBundle\\Entity\\Place' . "\0" . 'id', '' . "\0" . 'Admin\\AdminBundle\\Entity\\Place' . "\0" . 'latitude', '' . "\0" . 'Admin\\AdminBundle\\Entity\\Place' . "\0" . 'longitude', '' . "\0" . 'Admin\\AdminBundle\\Entity\\Place' . "\0" . 'address', '' . "\0" . 'Admin\\AdminBundle\\Entity\\Place' . "\0" . 'name', '' . "\0" . 'Admin\\AdminBundle\\Entity\\Place' . "\0" . 'description');
        }
